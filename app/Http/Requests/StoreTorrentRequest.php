...
class StoreTorrentRequest extends FormRequest
{
     ...
     *
     * @return array<string, array<Closure(string, mixed, Closure(string): never): void|\Illuminate\Validation\Rules\ProhibitedIf|\Illuminate\Validation\ConditionalRules|string>|string>
     */
