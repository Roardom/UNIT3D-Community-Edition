    ...
    public function index(Request $request): \Illuminate\Contracts\View\Factory|\Illuminate\View\View
    {
        ...
        return view('home.index', [
            ...
            'users'              => cache()->remember(
                'online_users:by-group:'.$user->group_id,
                $expiresAt,
            ...
            'topics'   => cache()->remember(
                'latest_topics:by-group:'.$user->group_id,
                $expiresAt,
                fn () => Topic::query()
            ...
            'posts' => cache()->remember(
                'latest_posts:by-group:'.$user->group_id,
                $expiresAt,
                fn () => Post::query()
                    ...
                    ->withExists([
                        ...
                        'dislikes' => fn ($query) => $query->where('user_id', '=', $user->id),
                    ])
                    ->authorized(canReadTopic: true)
                    ->latest()
                    ->take(5)
