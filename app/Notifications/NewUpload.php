...
class NewUpload extends Notification implements ShouldQueue
{
    ...
    {
        return [
            'title' => $this->torrent->user()->soleValue('username').' Has Uploaded A New Torrent',
            'body'  => sprintf('%s, whom you are following has uploaded Torrent %s', $this->torrent->user()->soleValue('username'), $this->torrent->name),
