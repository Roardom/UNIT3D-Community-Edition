...
account-notification-help = Control which notifications are sent concerning your account. These settings are overridden if you do not allow any groups to send notifications concerning your account or if you <strong>Disable Notifications</strong>
account-settings = Account Settings
achievement-privacy = Achievement Settings
achievement-privacy-list = Allow users to view a list of your achievements
achievement-help = Control the sharing of specific achievement related information with groups that are allowed to access to your profile. These settings are overridden if you do not allow any groups to access your achievements or if you <strong>Go Private</strong>
...
bon-notification-help = Control which notifications are sent concerning BON transactions. These settings are overridden if you do not allow any groups to send notifications concerning BON or if you <strong>Disable Notifications</strong>
bookmarks = Bookmarks
...
follower-help = Control the sharing of specific follower related information with groups that are allowed to access to your profile. These settings are overridden if you do not allow any groups to access your followers or if you <strong>Go Private</strong>
followers = Followers
following = Following
...
following-notification-help = Control which notifications are sent concerning followed user site actions. These settings are overridden if you do not allow any groups to send notifications concerning followed users or if you <strong>Disable Notifications</strong>
...
forum-notification-help = Control which notifications are sent concerning forum activities. These settings are overridden if you do not allow any groups to send notifications concerning forum activities or if you <strong>Disable Notifications</strong>
...
forum-help = Control the sharing of specific forum related statistics and information with groups that are allowed to access to your profile. These settings are overridden if you do not allow any groups to access your forum related statistics and information or if you <strong>Go Private</strong>
...
invites-rules =
    ...
    <li class="text-danger">Dont invite yourself, we check every invited user.</li>
    <li class="text-danger">Dont trade or sell Invites.</li>
...
mention-notification-help = Control which notifications are sent when a user @mentions you. These settings are overridden if you do not allow any groups to send notifications if a user @mentions you or if you <strong>Disable Notifications</strong>
...
notification-from-account-help = You will only receive account notifications from the system, staff and the following groups. These settings are overridden if you <strong>Disable Notifications</strong>
notification-from-bon = Receive BON Notifications From
notification-from-bon-help = You will only receive BON notifications from the system, staff and the following groups. These settings are overridden if you <strong>Disable Notifications</strong>
notification-from-following = Receive Followed User Notifications From
notification-from-following-help = You will only receive followed user notifications from the following groups. These settings are overridden if you <strong>Disable Notifications</strong>
notification-from-forum = Receive Forum Notifications From
notification-from-forum-help = You will only receive forum notifications from the system, staff and the following groups. These settings are overridden if you <strong>Disable Notifications</strong>
notification-from-subscription = Receive Subscription Notifications From
notification-from-subscription-help = You will only receive forum notifications from the system, staff and the following groups. These settings are overridden if you <strong>Disable Notifications</strong>
notification-from-torrent = Receive Torrent Notifications From
notification-from-torrent-help = You will only receive torrent notifications from the system, staff and the following groups. These settings are overridden if you <strong>Disable Notifications</strong>
notification-from-mention = Receive @Mention Notifications From
notification-from-mention-help = You will only receive @mention notifications from the system, staff and the following groups. These settings are overridden if you <strong>Disable Notifications</strong>
notification-from-request = Receive Request Notifications From
notification-from-request-help = You will only receive request notifications from the system, staff and the following groups. These settings are overridden if you <strong>Disable Notifications</strong>
notifications = Notifications
offline = User is Offline!
online = User is Online!
open-registration = Open Registration
options = Options
other-help = Control the sharing of other statistics and information with groups that are allowed to access to your profile. These settings are overridden if you do not allow any groups to access your other statistics and information or if you <strong>Go Private</strong>
...
profile-privacy-help = Control which statistics and pieces of information appear on your profile. These settings are overridden if you do not allow any groups to access your profile or if you <strong>Go Private</strong>
...
request-help = Control the sharing of specific request related statistics and information with groups that are allowed to access to your profile. These settings are overridden if you do not allow any groups to access your requested related statistics and information or if you <strong>Go Private</strong>
request = Request
requested = Requested
requests = Requests
...
request-notification-help = Control which notifications are sent concerning request activities. These settings are overridden if you do not allow any groups to send notifications concerning request activities or if you <strong>Disable Notifications</strong>
...
subscription-notification-help = Control which notifications are sent concerning your subscriptions. These settings are overridden if you do not allow any groups to send notifications concerning your subscriptions or if you <strong>Disable Notifications</strong>
...
torrent-help = Control the sharing of specific torrent related statistics and information with groups that are allowed to access to your profile. These settings are overridden if you do not allow any groups to access your torrent related statistics and information or if you <strong>Go Private</strong>
...
torrent-notification-help = Control which notifications are sent concerning torrent activities. These settings are overridden if you do not allow any groups to send notifications concerning torrent activities or if you <strong>Disable Notifications</strong>
...
visible-to-achievement-help = Your achievements will only be visible to staff and the following groups. These settings are overridden if you <strong>Go Private</strong>
visible-to-follower = Followers Visible To
visible-to-follower-help = Your followers will only be visible to staff and the following groups. These settings are overridden if you <strong>Go Private</strong>
visible-to-forum = Forum Information Visible To
visible-to-forum-help = Your forum information will only be visible to staff and the following groups. These settings are overridden if you <strong>Go Private</strong>
visible-to-other = Other Visible To
visible-to-other-help = Other information concerning your account will only be visible to staff and the following groups. These settings are overridden if you <strong>Go Private</strong> or if you <strong>Go Hidden</strong>
visible-to-profile = Profile Visible To
visible-to-profile-help = Your profile will only be visible to staff and the following groups. These settings are overridden if you <strong>Go Private</strong>
visible-to-request = Request Information Visible To
visible-to-request-help = Your request information will only be visible to staff and the following groups. These settings are overridden if you <strong>Go Private</strong>
visible-to-torrent = Torrent Information Visible To
visible-to-torrent-help = Your torrent information will only be visible to staff and the following groups. These settings are overridden if you <strong>Go Private</strong> or if you <strong>Go Hidden</strong>
warned-by = Warned By
warned-on = Warned On
warning = Warning
warnings = Warnings
