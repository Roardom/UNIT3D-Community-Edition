...
<footer class="footer">
    ...
    <section>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('blacklist') }}">{{ __('common.blacklist') }}</a>
            </li>
            <li>
    ...
    <section>
        <h2>{{ __('common.other') }}</h2>
        <ul>
            <li>
                <a href="https://github.com/sponsors/HDVinnie" target="_blank">{{ __('common.sponsor') }}</a>
            </li>
            <li>
                <a href="https://github.com/HDInnovations/UNIT3D" target="_blank">{{ __('common.powered-by') }}</a>
            </li>
        </ul>
    </section>
