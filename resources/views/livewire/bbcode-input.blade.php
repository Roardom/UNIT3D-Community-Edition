...
>
    ...
    <p class="bbcode-input__icon-bar-toggle">
        <button
            ...
            x-on:click="showButtons = ! showButtons"
        >
            BBCode
        </button>
    </p>
    <menu class="bbcode-input__icon-bar" x-cloak x-show="showButtons">
        ...
        <li>
            <button
                type="button"
                class="form__standard-icon-button"
                x-on:click="insert('[video=&quot;youtube&quot;]', '[/video]')"
            >
        ...
        <li>
            <button
                type="button"
                class="form__standard-icon-button"
                x-on:click="insert('[spoiler]', '[/spoiler]')"
            >
                <abbr title="Spoiler">
    ...
    <div class="bbcode-input__tab-pane">
        ...
        <p class="form__group" x-show="! isPreviewEnabled">
            <textarea
                ...
                x-bind:style="{
                    height: bbcodePreviewHeight !== null && bbcodePreviewHeight,
                    transition:
